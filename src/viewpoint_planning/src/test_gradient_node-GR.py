#!/usr/bin/env python3
"""
test_gradient_node.py
=====================
Runs GradientNBV for 12 iterations and saves:
  - results/results_gradientnbv_<occ>.json
  - results/plots/reconstruction_gradientnbv.png
  - results/plots/coverage_gradientnbv.png
  - results/plots/trajectory_3d_gradientnbv.png

Usage:
    python test_gradient_node.py
"""
