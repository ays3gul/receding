...
"""autogenerated by genpy from utils/GetTransformRequest.msg. Do not edit."""
import codecs
import sys
...
class GetTransformRequest(genpy.Message):
  ...
  _type = "utils/GetTransformRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from utils/GetTransformResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetTransformResponse(genpy.Message):
  _md5sum = "846e4c3d5961d5d48399d881e036019b"
  _type = "utils/GetTransformResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.success, _x.transform.header.seq, _x.transform.header.stamp.secs, _x.transform.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.transform.header.seq, _x.transform.header.stamp.secs, _x.transform.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
...
class GetTransform(object):
  _type          = 'utils/GetTransform'
  _md5sum = '4c5026dc3bd8461725969574664a41aa'
